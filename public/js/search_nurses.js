...
const search_input = document.getElementById("search-nurse-name");

search_input.addEventListener("keyup", (e) => {

    const search_value = e.target.value.toLowerCase();
    const fnCells = document.querySelectorAll("#nurses-table .first-name");
    const lnCells = document.querySelectorAll("#nurses-table .last-name");
